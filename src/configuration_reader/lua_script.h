...
// ========================================================================
#ifndef SRC_CONFIGURATION_READER_LUA_SCRIPT_H_
#define SRC_CONFIGURATION_READER_LUA_SCRIPT_H_
...
inline unsigned int LuaScript::lua_get<unsigned int>(
  ...
  return static_cast<unsigned int>(lua_tonumber(L, -1));
}
...
#endif  // SRC_CONFIGURATION_READER_LUA_SCRIPT_H_
