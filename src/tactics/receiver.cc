...
Receiver::Receiver(const WorldState& world_state, TacticArray* tactic_list,
    ...
    : StateMachineTactic("TestReceiver", world_state, tactic_list, shared_state,
      ...
      thresholds_receive_velocity_(800, "catch_velocity", this),
      thresholds_toward_target_(80, "toward_target", this),
      thresholds_toward_robot_(95, "toward_robot", this),
      thresholds_deflection_angle_(offense::kDeflectionAngle,
                                   "deflection_angle", this),
      thresholds_min_deflection_angle_(DegToRad(10.0), "min_deflection_angle",
                                       this),
      thresholds_setup_time_(999999, "setup_time", this),
      thresholds_setup_distance_(1000.0, "setup_distance", this),
      complete_(false),
