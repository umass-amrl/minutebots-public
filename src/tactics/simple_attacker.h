// Copyright 2018 - 2019 e@umass.edu ikhatri@umass.edu
...
#ifndef SRC_TACTICS_SIMPLE_ATTACKER_H_
#define SRC_TACTICS_SIMPLE_ATTACKER_H_
...
class SimpleAttacker : public StateMachineTactic {
 public:
  SimpleAttacker(const string& machine_name,
                  const state::WorldState& world_state,
                  TacticArray* tactic_list, state::SharedState* shared_state,
                  OurRobotIndex our_robot_index,
                  state::SoccerState* soccer_state);

  const char* Name() const override { return "simple_attacker"; }
  void Init() override;
  void Reset() override;
...
#endif  // SRC_TACTICS_SIMPLE_ATTACKER_H_
