...
Deflection::Deflection(const string& machine_name,
    ...
    : StateMachineTactic("TestStateMachineDeflection", world_state, tactic_list,
      ...
      ball_angle_threshold_(DegToRad(100.0), "angle", this),
      ball_velocity_threshold_(0, "ball_velocity_threshold", this),
      dribber_dampening_factor_(0.1, "dribber_dampening", this),
      ball_velocity_scale_(0.5, "ball_velocity_scale", this),
      angle_precision_threshold_(DegToRad(3.0), "angle_precision", this),
      robot_wait_threshold_y_max_(7, "robot_wait_vertical", this),
      robot_wait_threshold_tolerance_(5.2, "robot_wait_tolerance", this),
      robot_wait_threshold_x_(15, "robot_wait_horizontal", this),
      time_diff_threshold_(0.85 * 1000, "time_diff", this),
      kicked_x_threshold_(99, "kicked_x", this),
      kicked_velocity_threshold_(2, "kicked_velocity", this),
      thresholds_kick_timeout_(40, "kick_timeout", this),
      thresholds_kick_percent_(80, "kick_percent", this),
      thresholds_kick_speed_(1000, "kick_speed", this),
      thresholds_follow_through_(20, "kick_follow_through", this),
      thresholds_distance_(kRotationRadius, "distance", this),
      thresholds_setup_distance_(1000, "setup_distance", this),
      thresholds_deflection_angle_(offense::kDeflectionAngle,
