...
#ifndef SRC_TACTICS_EXAMPLE_ATTACKER_H_
#define SRC_TACTICS_EXAMPLE_ATTACKER_H_
...
class ExampleAttacker : public StateMachineTactic {
 public:
  ExampleAttacker(const string& machine_name,
...
#endif  // SRC_TACTICS_EXAMPLE_ATTACKER_H_
