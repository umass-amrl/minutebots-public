...
#ifndef SRC_TACTICS_TRIANGLE_ID_DEPENDENT_H_
#define SRC_TACTICS_TRIANGLE_ID_DEPENDENT_H_
...
namespace tactics {
class TriangleIdDependent : public Tactic {
 public:
  TriangleIdDependent(const state::WorldState& world_state,
           TacticArray* tactic_list,
           state::SharedState* shared_state, OurRobotIndex our_robot_index,
           state::SoccerState* soccer_state);

  const char* Name() const override { return "triangle_id_dependent"; }
  void Init() override;
  void Run() override;
...
#endif  // SRC_TACTICS_TRIANGLE_ID_DEPENDENT_H_
