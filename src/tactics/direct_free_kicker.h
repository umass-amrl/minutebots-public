...
#ifndef SRC_TACTICS_DIRECT_FREE_KICKER_H_
#define SRC_TACTICS_DIRECT_FREE_KICKER_H_
...
class DirectFreeKicker : public StateMachineTactic {
 public:
  DirectFreeKicker(const string& machine_name,
                   const state::WorldState& world_state,
                   TacticArray* tactic_list, state::SharedState* shared_state,
                   OurRobotIndex our_robot_index,
                   state::SoccerState* soccer_state);

  const char* Name() const override { return "direct_free_kicker"; }
  void Init() override;
  void Reset() override;
...
#endif  // SRC_TACTICS_DIRECT_FREE_KICKER_H_
