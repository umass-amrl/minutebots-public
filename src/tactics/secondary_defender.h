...
#ifndef SRC_TACTICS_SECONDARY_DEFENDER_H_
#define SRC_TACTICS_SECONDARY_DEFENDER_H_
...
// center of the goal.
class SecondaryDefender : public StateMachineTactic {
 public:
  SecondaryDefender(const state::WorldState& world_state,
                    TacticArray* tactic_list,
                    state::SharedState* shared_state,
                    OurRobotIndex our_robot_index,
                    state::SoccerState* soccer_state);

  const char* Name() const override { return "secondary_defender"; }
  void Init() override;
  void Reset() override;
...
#endif  // SRC_TACTICS_SECONDARY_DEFENDER_H_
