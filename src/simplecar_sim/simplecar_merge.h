...
// ========================================================================
#ifndef SRC_SIMPLECAR_SIM_SIMPLECAR_MERGE_H_
#define SRC_SIMPLECAR_SIM_SIMPLECAR_MERGE_H_
...
class SimplecarMerge : public srtr::StateMachine {
 public:
  SimplecarMerge(const string& machine_name, const int& id);
 ...
 private:
  ...
  RepairableParam merge_space_back_;
  RepairableParam crash_threshold_;
  RepairableParam decel_threshold_;
  RepairableParam wait_dist_threshold_;
...
#endif  // SRC_SIMPLECAR_SIM_SIMPLECAR_MERGE_H_
