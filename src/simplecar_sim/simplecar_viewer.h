...
#ifndef SRC_SIMPLECAR_SIM_SIMPLECAR_VIEWER_H_
#define SRC_SIMPLECAR_SIM_SIMPLECAR_VIEWER_H_
...
class Viewer : public QWidget {
 ...
 private:
  ...
  // Soccer field viewer.
  gui::GLCarView field_;
  // Text tree log viewer.
  gui::TextTreeViewer text_log_;
  // Graph visuzlizer.
  gui::GLGraph graph_;
  // Horizontal divider.
  ...
  gui::DataEntry GenBallData(const MinuteBotsProto::SoccerDebugMessage& msg);
};

}  // namespace simplecar

#endif  // SRC_SIMPLECAR_SIM_SIMPLECAR_VIEWER_H_
