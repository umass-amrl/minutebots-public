...
plot_helper.plot_ci(kNumRobotsList, xstar_firsts_lst, 4, "Lazy X* First Search")
plot_helper.plot_ci(kNumRobotsList, xstar_totals_lst, 4, "Lazy X* Full Search")
plot_helper.plot_ci(kNumRobotsList, eager_xstar_firsts_lst, 4, "Eager X* First Search")
plot_helper.plot_ci(kNumRobotsList, eager_xstar_totals_lst, 4, "Eager X* Full Search")
