...
#ifndef SRC_DEFLECTION_SIM_OBJECTS_BALL_H_
#define SRC_DEFLECTION_SIM_OBJECTS_BALL_H_
...
class Ball {
 public:
  Ball(const pose_2d::Pose2Df initial_pose,
...
#endif  // SRC_DEFLECTION_SIM_OBJECTS_BALL_H_
